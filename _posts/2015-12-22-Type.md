...
Above information needs to be retrieved when the script wants to get or set the property. A typical way to store this information is in a form of a property map and a slot array.
