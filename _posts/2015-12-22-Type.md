...
Going deeper into these optimizations necessitates a separate post. First we need understand how this type hierarchy is built. [Typehanlder](https://github.com/Microsoft/ChakraCore/blob/master/lib/Runtime/Types/DynamicType.h#L28) in dynamic type handles how the property map is stored and how a brand vanilla dynamic object gets its type. 
