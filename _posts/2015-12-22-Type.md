...
It may bit hard to image what is the use of sharing a integer TypeId when you have pointer to the type. Type contains lot of additional data such as prototype information 
