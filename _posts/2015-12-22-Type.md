...
We looked at why objects have types and how it shares data. We also looked at briefly at how type handle stores a pointer to successor types. There are various other type handlers which share data differently or not share at all.  

In my opinion biggest advantage of type is inline cache. We will look into the inline cache in the next post. Feel free to ask me more questions on this topic in the comments. 
