...
The same type can be shared by all the objects created from constructor *Point*. Even if you create a million *Points*, you just need a type to represent them all. Memory saving is just tip of the iceberg. Ton of optimizations are made possible by the type. I will note a bunch here:
