...
Inline cache [wiki](https://en.wikipedia.org/wiki/Inline_caching) page and [type](abchatra.github.com/Type) are necessary read before we begin our discussion on implementation of inline cache in Chakra. Quote from wiki:
